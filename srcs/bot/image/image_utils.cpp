...
void	set_standart_headers(struct curl_slist **headers) { *headers = curl_slist_append(*headers, "User-Agent: Mozilla/5.0 (X11; Fedora; Linux x86_64; rv:93.0) Gecko/20100101 Firefox/93.0"); }
